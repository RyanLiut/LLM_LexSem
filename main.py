...
def extract_sentence(txt_path, gold_path, mark, prev=1):
...
def get_batch_data(sents_list, inx_list, batch_size=50, prompt=None):
    batch_list = []
    tar_inx_list = []
    for i in range(len(sents_list)//batch_size):
...
if __name__ == "__main__":
    ...
    sents_list_1, sents_list_2, GT_list, inx_list = extract_sentence(txt_path, gold_path, mark)
